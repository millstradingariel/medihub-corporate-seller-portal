            ...
            <div className="mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 space-y-4 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
                        ...
                        <p className="text-zinc-400 text-sm mb-1">Consultation Fees</p>
                        <p className="text-3xl font-bold text-white">
                            ${Number(accountData?.commission ?? 0).toLocaleString('en-AU', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                        </p>
                    </div>
